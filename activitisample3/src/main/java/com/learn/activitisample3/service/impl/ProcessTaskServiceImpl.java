...
public class ProcessTaskServiceImpl implements ProcessTaskService{
    ...
    @Override
    public List<Task> getAllActivityTask() {
        return null;
    }

    @Override
    @SuppressWarnings("unchecked")
    public List<Task> getTaskByProcessInstanceId(int page, int size, String processInstanceId) {
        return queryTool.query(page,size,processInstanceId,queryTool.QUERY_TASK_BY_PROCESS_INSTANCE_ID);
    }
